  ...
  function(options) {
    ...
    return this.each( function() {
      ...
      if ($this.paint.type == "none") {
        $this.paint = $.jGraduate.Paint({solidColor: 'ffffff'});
            ...
            $this.html('<ul class="jGraduate_tabs">' +
                    '<li class="jGraduate_tab_color jGraduate_tab_current" data-type="col">Màu đơn sắc</li>' +
                    '<li class="jGraduate_tab_lingrad" data-type="lg">Chuyển sắc tuyến tính</li>' +
                    '<li class="jGraduate_tab_radgrad" data-type="rg">Chuyển sắc hướng tâm</li>' +
                  '</ul>' +
      ...
      var gradPicker = $(idref + '> .jGraduate_gradPick');
            ...
            gradPicker.html(
              ...
              '<div class="jGraduate_Form jGraduate_Points jGraduate_lg_field">' +
                '<div class="jGraduate_StopSection">' +
                  '<label class="jGraduate_Form_Heading">Điểm đầu</label>' +
                ...
                '</div>' +
                '<div class="jGraduate_StopSection">' +
                  '<label class="jGraduate_Form_Heading">Điểm cuối</label>' +
                  '<div class="jGraduate_Form_Section">' +
                    '<label>x:</label>' +
          ...
          '<div class="jGraduate_StopSection">' +
            '<label class="jGraduate_Form_Heading">Tâm điểm</label>' +
            '<div class="jGraduate_Form_Section">' +
              '<label>x:</label>' +
        ...
        '</div>' +
            ...
            '<label><input type="text" id="' + id + '_jGraduate_OpacInput" size="3" value="100"/>%</label>' + 
              ...
              '<div class="jGraduate_OkCancel">' +
                '<input type="button" id="' + id + '_jGraduate_Ok" class="jGraduate_Ok" value="Xong"/>' +
                '<input type="button" id="' + id + '_jGraduate_Cancel" class="jGraduate_Cancel" value="Hủy bỏ"/>' +
              '</div>');
